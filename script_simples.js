        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(index, tarefa) {
                    $('#tarefas-lista').append(`<tr><td>${tarefa.id}</td><td>${tarefa.titulo}</td><td>${tarefa.status}</td><td>${tarefa.descricao}</td><td>${tarefa.data_inicio}</td><td>${tarefa.data_termino}</td></tr>`);
                });
            },
            error: function() {
